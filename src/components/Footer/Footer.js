              ...
              <ul className={css.list}>
                ...
                <li className={css.listItem}>
                  <NamedLink
                    ...
                    className={css.link}
                  >
                    <FormattedMessage id="Santa Rosa" />
                  </NamedLink>
                </li>
                <li className={css.listItem}>
                  <NamedLink
              ...
              <ul className={css.list}>
                <li className={css.listItem}>
                  <NamedLink
                    ...
                    className={css.link}
                  >
                    <FormattedMessage id="Santa Clara" />
                  </NamedLink>
                </li>
                <li className={css.listItem}>
                  <NamedLink
